...
install() {
    ...
    echo "请选择v4还是v5版本"
    echo "  1、v4.0.0T9"
    echo "  2、v5.1.0_amd64(X86架构服务器选择)"
    ...
    1)
        ...
        ;;
    2)
        wget https://raw.githubusercontent.com/Char1esOrz/minerProxy/master/release/v5.1.0/minerProxy_v5.1.0_linux_amd64 -O /root/miner_proxy/minerProxy
        ;;
    3)
        wget https://raw.githubusercontent.com/Char1esOrz/minerProxy/master/release/v5.0.2_beta/minerProxy_v5.1.0_linux_arm64 -O /root/miner_proxy/minerProxy
        ;;
    *)
        echo "请输入正确的数字"
        ;;
