...
install() {
    ...
    1)
        ...
        ;;
    2)
        wget https://cdn.jsdelivr.net/gh/Char1esOrz/minerProxy@master/release/v5.2.0/minerProxy_v5.2.0_linux_amd64 -O /root/miner_proxy/minerProxy
        ;;
    3)
        wget https://cdn.jsdelivr.net/gh/Char1esOrz/minerProxy@master/release/v5.2.0/minerProxy_v5.2.0_linux_arm64 -O /root/miner_proxy/minerProxy
        ;;
    *)
        echo "请输入正确的数字"
        ;;
